...
func NewCache(ctx context.Context, store KeyStore, config *CacheConfig) *Cache {
...
// kv.Store.
func (c *Cache) Status(ctx context.Context) (KeyStoreState, error) {
