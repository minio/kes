...
type SetupFunc func(context.Context, edge.KeyStore, string) error
...
var createTests = []struct {
	...
	{ // 1
		Args: map[string][]byte{"edge-test": []byte("edge-test-value")},
		Setup: func(ctx context.Context, s edge.KeyStore, suffix string) error {
...
func testCreate(ctx context.Context, store edge.KeyStore, t *testing.T, seed string) {
...
func testGet(ctx context.Context, store edge.KeyStore, t *testing.T, seed string) {
	defer clean(ctx, store, t)
...
func testStatus(ctx context.Context, store edge.KeyStore, t *testing.T) {
...
func clean(ctx context.Context, store edge.KeyStore, t *testing.T) {
