...
type VersionOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.EncryptionVersionResponse `json:"body,omitempty"`
}
...
func (o *VersionOK) WithPayload(payload *models.EncryptionVersionResponse) *VersionOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the version o k response
func (o *VersionOK) SetPayload(payload *models.EncryptionVersionResponse) {
	o.Payload = payload
}
...
/*
VersionDefault Generic error response.
