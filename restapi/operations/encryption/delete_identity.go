...
type DeleteIdentityHandlerFunc func(DeleteIdentityParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteIdentityHandlerFunc) Handle(params DeleteIdentityParams, principal *models.Principal) middleware.Responder {
...
type DeleteIdentityHandler interface {
	Handle(DeleteIdentityParams, *models.Principal) middleware.Responder
}
...
/*
	DeleteIdentity swagger:route DELETE /encryption/identities/{name} Encryption deleteIdentity

Encryption delete identity
*/
