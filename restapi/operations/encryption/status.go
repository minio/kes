...
type StatusHandlerFunc func(StatusParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn StatusHandlerFunc) Handle(params StatusParams, principal *models.Principal) middleware.Responder {
	return fn(params, principal)
}

// StatusHandler interface for that can handle valid status params
type StatusHandler interface {
	Handle(StatusParams, *models.Principal) middleware.Responder
}
...
/*
	Status swagger:route GET /encryption/status Encryption status
