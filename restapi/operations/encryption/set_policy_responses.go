...
// SetPolicyOKCode is the HTTP code returned for type SetPolicyOK
const SetPolicyOKCode int = 200

/*
SetPolicyOK A successful response.

swagger:response setPolicyOK
*/
type SetPolicyOK struct {
}

// NewSetPolicyOK creates SetPolicyOK with default headers values
func NewSetPolicyOK() *SetPolicyOK {

	return &SetPolicyOK{}
}

// WriteResponse to the client
func (o *SetPolicyOK) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
