...
/*
GetPolicyOK A successful response.
...
type GetPolicyOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.EncryptionGetPolicyResponse `json:"body,omitempty"`
}
...
func (o *GetPolicyOK) WithPayload(payload *models.EncryptionGetPolicyResponse) *GetPolicyOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get policy o k response
func (o *GetPolicyOK) SetPayload(payload *models.EncryptionGetPolicyResponse) {
	o.Payload = payload
}
...
/*
GetPolicyDefault Generic error response.
