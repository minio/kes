...
type AssignPolicyParams struct {
	...
	/*
	  ...
	  In: body
	*/
	Body *models.EncryptionAssignPolicyRequest
	/*enclave to be used
	  Required: true
	  In: query
	*/
...
func (o *AssignPolicyParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.EncryptionAssignPolicyRequest
...
func (o *AssignPolicyParams) bindEnclave(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *AssignPolicyParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
