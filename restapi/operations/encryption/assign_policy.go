...
type AssignPolicyHandlerFunc func(AssignPolicyParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn AssignPolicyHandlerFunc) Handle(params AssignPolicyParams, principal *models.Principal) middleware.Responder {
	return fn(params, principal)
}

// AssignPolicyHandler interface for that can handle valid assign policy params
type AssignPolicyHandler interface {
	Handle(AssignPolicyParams, *models.Principal) middleware.Responder
}
...
/*
	AssignPolicy swagger:route POST /encryption/policies/{name}/assign Encryption assignPolicy

Encryption assign policy
*/
