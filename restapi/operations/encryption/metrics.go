...
type MetricsHandlerFunc func(MetricsParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn MetricsHandlerFunc) Handle(params MetricsParams, principal *models.Principal) middleware.Responder {
	return fn(params, principal)
}

// MetricsHandler interface for that can handle valid metrics params
type MetricsHandler interface {
	Handle(MetricsParams, *models.Principal) middleware.Responder
}
...
/*
	Metrics swagger:route GET /encryption/metrics Encryption metrics
