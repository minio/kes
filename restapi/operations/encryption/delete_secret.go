...
type DeleteSecretHandlerFunc func(DeleteSecretParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteSecretHandlerFunc) Handle(params DeleteSecretParams, principal *models.Principal) middleware.Responder {
	return fn(params, principal)
}

// DeleteSecretHandler interface for that can handle valid delete secret params
type DeleteSecretHandler interface {
	Handle(DeleteSecretParams, *models.Principal) middleware.Responder
}
...
/*
	DeleteSecret swagger:route DELETE /encryption/secrets/{name} Encryption deleteSecret

Encryption delete secret
*/
