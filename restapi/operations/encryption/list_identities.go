...
type ListIdentitiesHandlerFunc func(ListIdentitiesParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn ListIdentitiesHandlerFunc) Handle(params ListIdentitiesParams, principal *models.Principal) middleware.Responder {
...
type ListIdentitiesHandler interface {
	Handle(ListIdentitiesParams, *models.Principal) middleware.Responder
}
...
/*
	ListIdentities swagger:route GET /encryption/identities Encryption listIdentities

Encryption list identities
*/
