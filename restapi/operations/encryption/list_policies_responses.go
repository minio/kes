...
type ListPoliciesOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.EncryptionListPoliciesResponse `json:"body,omitempty"`
}
...
func (o *ListPoliciesOK) WithPayload(payload *models.EncryptionListPoliciesResponse) *ListPoliciesOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list policies o k response
func (o *ListPoliciesOK) SetPayload(payload *models.EncryptionListPoliciesResponse) {
	o.Payload = payload
}
