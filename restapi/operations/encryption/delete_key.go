...
type DeleteKeyHandlerFunc func(DeleteKeyParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteKeyHandlerFunc) Handle(params DeleteKeyParams, principal *models.Principal) middleware.Responder {
	return fn(params, principal)
}

// DeleteKeyHandler interface for that can handle valid delete key params
type DeleteKeyHandler interface {
	Handle(DeleteKeyParams, *models.Principal) middleware.Responder
}
...
/*
	DeleteKey swagger:route DELETE /encryption/keys/{name} Encryption deleteKey

Encryption delete key
*/
