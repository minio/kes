...
import (
	...
	kmsAPI "github.com/minio/kes/restapi/operations/k_m_s"
)

func registerKMSHandlers(api *operations.KesAPI) {
...
func registerKMSStatusHandlers(api *operations.KesAPI) {
...
func registerKMSKeyHandlers(api *operations.KesAPI) {
...
func registerKMSPolicyHandlers(api *operations.KesAPI) {
...
func registerKMSIdentityHandlers(api *operations.KesAPI) {
