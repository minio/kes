...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  encryption = {
     ...
     * @secure
     */
    importKey: (name: string, body: EncryptionImportKeyRequest, params: RequestParams = {}) =>
      this.request<void, Error>({
     ...
     * @secure
     */
    assignPolicy: (name: string, body: EncryptionAssignPolicyRequest, params: RequestParams = {}) =>
      this.request<void, Error>({
     ...
     * @secure
     */
    createSecret: (body: EncryptionCreateSecretRequest, params: RequestParams = {}) =>
      this.request<void, Error>({
