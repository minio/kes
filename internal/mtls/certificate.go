...
// CertificateFromFile reads a TLS certificate and private key from the specified
// files and returns a tls.Certificate. An optional password can be specified to
// decrypt an encrypted private key. CertificateFromFile guarantees that returned
// leaf certificate is non-nil.
